...
export async function getGitPostData(params) {
  ...
  const res = await axios({
    method: "get",
    responseType: "blob",
    url: `https://gitee.com/api/v5/repos/coffeegirl/test-data/git/blobs/${params}?access_token=acd71d3f8fe43bcf58b556de87dca3fe`,
  });
  let decodeRes = new Buffer(res.data, "base64");
  console.log(decodeRes, "decodeRes");
  //   const res = await fetch(
  //     `https://gitee.com/api/v5/repos/coffeegirl/test-data/git/blobs/${params}?access_token=acd71d3f8fe43bcf58b556de87dca3fe`
  //   );
